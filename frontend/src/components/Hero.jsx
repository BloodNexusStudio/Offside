...
const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="relative w-full min-h-[calc(100vh-160px)] md:h-[calc(100vh-160px)] md:min-h-[600px] flex items-center overflow-hidden my-6 sm:my-10">
      
      {/* Content Container */}
      <div className="w-full grid grid-cols-1 md:grid-cols-2 h-full">
        
        {/* Left Content */}
        <div className="flex flex-col justify-center h-full sm:pr-8 pt-16 md:pt-0 pb-12">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <h1 ref={textRef} className="text-4xl sm:text-5xl lg:text-6xl xl:text-[4rem] 2xl:text-[4.5rem] font-heading font-bold leading-[1.1] md:leading-[0.9] text-offside-black mb-6 uppercase">
